import{m as b,t as x,s as l,r as v}from"./toast-k8OKon_N.js";import{f as g,h as y,u as w}from"./storage-BWz5GEzr.js";import{c as h}from"./calculations-CDT-qs_O.js";import{r as E}from"./running-estimate-CZ2yY7Np.js";import{i as u}from"./index-Bp3_zzYf.js";let r=null,s=null,t=null,p=null;const I=()=>`
  ${v()}
...
`,k=async f=>{b();const n=document.getElementById("mobile-menu-btn");n&&n.addEventListener("click",x);const i=f.split("/");r=i[1],s=i[3];const a={labor:document.getElementById("laborCost"),elec:document.getElementById("elecCost")};try{p=await g(),t=await y(r,s),t&&t.rates&&(a.labor.value=t.rates.laborCost||"",a.elec.value=t.rates.electricityCost||"")}catch(e){l("Error loading data: "+u(e),"error")}const d=()=>{const e={...t};e.rates={laborCost:parseFloat(a.labor.value)||0,electricityCost:parseFloat(a.elec.value)||0};const o=h(e,p);document.getElementById("estimate-container").innerHTML=E(o)};document.querySelectorAll(".input-trigger").forEach(e=>{e.addEventListener("input",d)}),d();const c=document.getElementById("step-loading-overlay");c&&c.classList.add("hidden");const m=async()=>{const e={laborCost:parseFloat(a.labor.value)||0,electricityCost:parseFloat(a.elec.value)||0};try{return await w(r,s,{rates:e,currentStep:Math.max(t.currentStep||1,7)}),t.rates=e,!0}catch(o){return l("Failed to save draft: "+u(o),"error"),!1}};document.getElementById("save-draft-btn").addEventListener("click",async()=>{await m()&&l("Draft saved successfully")}),document.getElementById("next-btn").addEventListener("click",async()=>{await m()&&(window.location.hash=`#project/${r}/sheet/${s}/step/7`)})};export{k as mount,I as render};
