import{l as m,n as u,g as f}from"./index-CDlMNROc.js";const g=()=>`
...
`,x=()=>{let t=!0;const a=document.getElementById("login-form"),n=document.getElementById("name-field"),s=document.getElementById("toggle-mode-btn"),l=document.getElementById("toggle-text"),e=document.getElementById("submit-btn"),o=document.getElementById("error-message");s.addEventListener("click",()=>{t=!t,o.classList.add("hidden"),a.reset(),t?(n.classList.add("hidden"),n.querySelector("input").required=!1,e.textContent="Sign In",l.textContent="Don't have an account?",s.textContent="Sign Up"):(n.classList.remove("hidden"),n.classList.add("flex"),n.querySelector("input").required=!0,e.textContent="Create Account",l.textContent="Already have an account?",s.textContent="Sign In")}),a.addEventListener("submit",async d=>{d.preventDefault(),o.classList.add("hidden"),e.disabled=!0,e.innerHTML='<div class="spinner spinner-sm"></div>';try{const r=document.getElementById("email").value,i=document.getElementById("password").value;if(t)await m(r,i);else{const c=document.getElementById("name").value;await u(r,i,c)}}catch(r){o.textContent=f(r),o.classList.remove("hidden"),e.disabled=!1,e.textContent=t?"Sign In":"Create Account"}})};export{x as mount,g as render};
