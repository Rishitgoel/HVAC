import{m as u,t as p,r as b}from"./sidebar-cBYwUFB1.js";import{f,s as m}from"./storage-BgqC2MNh.js";import{i as x}from"./index-CteE1Qgu.js";import{s as l}from"./toast-D62CK5oX.js";const F=()=>`
  ${b("#settings")}
...
`,P=async()=>{u();const n=document.getElementById("mobile-menu-btn");n&&n.addEventListener("click",p);const i=x(),d=document.getElementById("settings-form"),a=document.getElementById("save-settings-btn"),c=document.getElementById("read-only-banner");i?a.classList.remove("hidden"):(c.classList.remove("hidden"),d.querySelectorAll("input, select").forEach(r=>{r.disabled=!0,r.classList.add("bg-surface-container-low","text-on-surface-variant","cursor-not-allowed")}));try{const e=await f();["unitSystem","taxRate","aluminumRate","giRate","puffPanelRate","forwardFanPrice","backwardFanPrice","plugFanPrice","ecFanPrice","coilRate","brownPadRate","greenPadRate","preFilterPrice","fineFilterPrice","hepaFilterPrice"].forEach(t=>{const s=document.getElementById(t);s&&e[t]!==void 0&&(s.value=e[t])}),o(e.unitSystem||"sqft")}catch{l("Error loading settings","error")}document.getElementById("unitSystem").addEventListener("change",e=>o(e.target.value));function o(e){const r=e==="sqm"?"sq.m":"sq.ft";document.querySelectorAll(".unit-label").forEach(t=>{t.textContent=r})}i&&a.addEventListener("click",async()=>{a.disabled=!0,a.innerHTML='<span class="material-symbols-outlined animate-spin text-[18px]">progress_activity</span>';const e={};["unitSystem","taxRate","aluminumRate","giRate","puffPanelRate","forwardFanPrice","backwardFanPrice","plugFanPrice","ecFanPrice","coilRate","brownPadRate","greenPadRate","preFilterPrice","fineFilterPrice","hepaFilterPrice"].forEach(t=>{const s=document.getElementById(t).value;e[t]=t==="unitSystem"?s:parseFloat(s)||0});try{await m(e),l("Settings saved successfully!")}catch{l("Error saving settings","error")}finally{a.disabled=!1,a.innerHTML='<span class="material-symbols-outlined text-[18px]">save</span><span class="hidden md:inline">Save Changes</span>'}})};export{P as mount,F as render};
