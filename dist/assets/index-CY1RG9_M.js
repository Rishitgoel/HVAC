const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dashboard-CSDr2bvV.js","assets/toast-Cssg3beC.js","assets/storage-90-9ZAWB.js","assets/settings-GmQ7819r.js","assets/project-detail-C--AaqMI.js","assets/_commonjsHelpers-Cpj98o6Y.js","assets/pdf-generator-DlcMt94w.js","assets/calculations-CDT-qs_O.js","assets/client-info-Drk8MKzU.js","assets/stepper-WTnawPLe.js","assets/architecture-DLokWkx0.js","assets/running-estimate-CZ2yY7Np.js","assets/air-movement-TGkDgeWJ.js","assets/thermodynamics-Bs3xHHuC.js","assets/filtration-CD3hjQvg.js","assets/rates-D5dwyowb.js","assets/quote-summary-BQhFISFD.js","assets/shared-view-CWQb9CLn.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Ud(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function Ud(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const cs="@firebase/app",Ma="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const If=1024,Tf=30*24*60*60*1e3;class wf{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Rf(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Ua();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o)?void 0:(this._heartbeatsCache.heartbeats.push({date:o,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(a=>{const u=new Date(a.date).valueOf();return Date.now()-u<=Tf}),this._storage.overwrite(this._heartbeatsCache))}catch(r){Ge.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Ua(),{heartbeatsToSend:r,unsentEntries:i}=Af(this._heartbeatsCache.heartbeats),o=Wr(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(t){return Ge.warn(t),""}}}function Ua(){return new Date().toISOString().substring(0,10)}function Af(n,e=If){const t=[];let r=n.slice();for(const i of n){const o=t.find(a=>a.agent===i.agent);if(o){if(o.dates.push(i.date),Ba(t)>e){o.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),Ba(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class Rf{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ld()?hd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Ef(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return Fa(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return Fa(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Ba(n){return Wr(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pf(n){Qt(new St("platform-logger",e=>new Fd(e),"PRIVATE")),Qt(new St("heartbeat",e=>new wf(e),"PRIVATE")),ht(cs,Ma,n),ht(cs,Ma,"esm2017"),ht("fire-js","")}Pf("");var Sf="firebase",Cf="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class L{constructor(e){this.path=e}static fromPath(e){return new L(J.fromString(e))}static fromName(e){return new L(J.fromString(e).popFirst(5))}static empty(){return new L(J.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return e!==null&&J.comparator(this.path,e.path)===0}toString(){return this.path.toString()}static comparator(e,t){return J.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new L(new J(e.slice()))}}function Jm(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,i=F.fromTimestamp(r===1e9?new se(t+1,0):new se(t,r));return new ft(i,L.empty(),e)}function Xm(n){return new ft(n.readTime,n.key,-1)}class ft{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new ft(F.min(),L.empty(),-1)}static max(){return new ft(F.max(),L.empty(),-1)}}function Zm(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=L.comparator(n.documentKey,e.documentKey),t!==0?t:z(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sl{constructor(e,t,r,i,o,a,u,l){this.ui=e,this.Ho=r,this.Jo=i,this.connection=o,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=u,this.listener=l,this.state=0,this.Yo=0,this.Zo=null,this.Xo=null,this.stream=null,this.e_=0,this.t_=new Pl(e,t)}n_(){return this.state===1||this.state===5||this.r_()}r_(){return this.state===2||this.state===3}start(){this.e_=0,this.state!==4?this.auth():this.i_()}async stop(){this.n_()&&await this.close(0)}s_(){this.state=0,this.t_.reset()}o_(){this.r_()&&this.Zo===null&&(this.Zo=this.ui.enqueueAfterDelay(this.Ho,6e4,()=>this.__()))}a_(e){this.u_(),this.stream.send(e)}async __(){if(this.r_())return this.close(0)}u_(){this.Zo&&(this.Zo.cancel(),this.Zo=null)}c_(){this.Xo&&(this.Xo.cancel(),this.Xo=null)}async close(e,t){this.u_(),this.c_(),this.t_.cancel(),this.Yo++,e!==4?this.t_.reset():t&&t.code===P.RESOURCE_EXHAUSTED?(Ye(t.toString()),Ye("Using maximum backoff delay to prevent overloading the backend."),this.t_.Wo()):t&&t.code===P.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.l_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.mo(t)}l_(){}auth(){this.state=1;const e=this.h_(this.Yo),t=this.Yo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([r,i])=>{this.Yo===t&&this.P_(r,i)},r=>{e(()=>{const i=new D(P.UNKNOWN,"Fetching auth token failed: "+r.message);return this.I_(i)})})}P_(e,t){const r=this.h_(this.Yo);this.stream=this.T_(e,t),this.stream.Eo(()=>{r(()=>this.listener.Eo())}),this.stream.Ro(()=>{r(()=>(this.state=2,this.Xo=this.ui.enqueueAfterDelay(this.Jo,1e4,()=>(this.r_()&&(this.state=3),Promise.resolve())),this.listener.Ro()))}),this.stream.mo(i=>{r(()=>this.I_(i))}),this.stream.onMessage(i=>{r(()=>++this.e_==1?this.E_(i):this.onNext(i))})}i_(){this.state=5,this.t_.Go(async()=>{this.state=0,this.start()})}I_(e){return N("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(4,e)}h_(e){return t=>{this.ui.enqueueAndForget(()=>this.Yo===e?t():(N("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class x_ extends Sl{constructor(e,t,r,i,o,a){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,r,i,a),this.serializer=o}T_(e,t){return this.connection.Bo("Listen",e,t)}E_(e){return this.onNext(e)}onNext(e){this.t_.reset();const t=Qg(this.serializer,e),r=function(o){if(!("targetChange"in o))return F.min();const a=o.targetChange;return a.targetIds&&a.targetIds.length?F.min():a.readTime?xe(a.readTime):F.min()}(e);return this.listener.d_(t,r)}A_(e){const t={};t.database=Rs(this.serializer),t.addTarget=function(o,a){let u;const l=a.target;if(u=vs(l)?{documents:Xg(o,l)}:{query:Zg(o,l)._t},u.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){u.resumeToken=_l(o,a.resumeToken);const d=Ts(o,a.expectedCount);d!==null&&(u.expectedCount=d)}else if(a.snapshotVersion.compareTo(F.min())>0){u.readTime=ni(o,a.snapshotVersion.toTimestamp());const d=Ts(o,a.expectedCount);d!==null&&(u.expectedCount=d)}return u}(this.serializer,e);const r=t_(this.serializer,e);r&&(t.labels=r),this.a_(t)}R_(e){const t={};t.database=Rs(this.serializer),t.removeTarget=e,this.a_(t)}}class F_ extends Sl{constructor(e,t,r,i,o,a){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,r,i,a),this.serializer=o}get V_(){return this.e_>0}start(){this.lastStreamToken=void 0,super.start()}l_(){this.V_&&this.m_([])}T_(e,t){return this.connection.Bo("Write",e,t)}E_(e){return G(!!e.streamToken),this.lastStreamToken=e.streamToken,G(!e.writeResults||e.writeResults.length===0),this.listener.f_()}onNext(e){G(!!e.streamToken),this.lastStreamToken=e.streamToken,this.t_.reset();const t=Jg(e.writeResults,e.commitTime),r=xe(e.commitTime);return this.listener.g_(r,t)}p_(){const e={};e.database=Rs(this.serializer),this.a_(e)}m_(e){const t={streamToken:this.lastStreamToken,writes:e.map(r=>Yg(this.serializer,r))};this.a_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $y(n){n=Ue(n,we);const e=Ue(n.firestore,ln);return wy(po(e),n._key).then(t=>Wy(e,n,t))}class oh extends Uy{constructor(e){super(),this.firestore=e}convertBytes(e){return new nn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new we(this.firestore,null,t)}}function iv(n){n=Ue(n,Mt);const e=Ue(n.firestore,ln),t=po(e),r=new oh(e);return Fy(n._query),Ay(t,n._query).then(i=>new jy(e,r,n,i))}function zy(n,e,t){n=Ue(n,we);const r=Ue(n.firestore,ln),i=By(n.converter,e,t);return So(r,[Dy(yo(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,ke.none())])}function sv(n,e,t,...r){n=Ue(n,we);const i=Ue(n.firestore,ln),o=yo(i);let a;return a=typeof(e=ae(e))=="string"||e instanceof Ii?Oy(o,"updateDoc",n._key,e,t,r):Ny(o,"updateDoc",n._key,e),So(i,[a.toMutation(n._key,ke.exists(!0))])}function ov(n){return So(Ue(n.firestore,ln),[new Xs(n._key,ke.none())])}function So(n,e){return function(r,i){const o=new Ke;return r.asyncQueue.enqueueAndForget(async()=>dy(await Ty(r),i,o)),o.promise}(po(n),e)}function Wy(n,e,t){const r=t.docs.get(e._key),i=new oh(n);return new sh(n,i,e._key,r,new On(t.hasPendingWrites,t.fromCache),e.converter)}function Hy(){return new vo("serverTimestamp")}(function(e,t=!0){(function(i){on=i})(rn),Qt(new St("firestore",(r,{instanceIdentifier:i,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ln(new zm(r.getProvider("auth-internal")),new Gm(r.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new D(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Wn(d.options.projectId,p)}(a,i),a);return o=Object.assign({useFetchStreams:t},o),u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),ht(ac,"4.7.3",e),ht(ac,"4.7.3","esm2017")})();const Ky={apiKey:"AIzaSyANXDyovz5ywdh6q4kARljj547qjNmJXCU",authDomain:"hvac-cost-estimator.firebaseapp.com",projectId:"hvac-cost-estimator",storageBucket:"hvac-cost-estimator.firebasestorage.app",messagingSenderId:"901722206058",appId:"1:901722206058:web:9b446346c6c5fb4cdebf13"},ah=eu(Ky),Ai=Bm(ah),ch=Sy(ah);let Co=null,Rt=null;const av=async(n,e)=>{const t=await Rp(Ai,n,e);return await bo(t.user.uid),t.user},cv=async(n,e,t)=>{const i=(await Ap(Ai,n,e)).user;return await zy(Yl(ch,"users",i.uid),{email:i.email,name:t,role:"user",createdAt:Hy()}),await bo(i.uid),i},uv=()=>(Co=null,Rt=null,bp(Ai)),bo=async n=>{try{const e=await $y(Yl(ch,"users",n));e.exists()?Rt=e.data().role:Rt="user"}catch(e){console.error("Error fetching role:",e),Rt="user"}return Rt},lv=()=>Co,hv=()=>Rt==="admin",Gy=(n,e="An error occurred")=>n?(n.message||n.toString()).replace(/^Firebase:\s*/i,"").replace(/\s*\(auth\/[^\)]+\)\.?$/i,"").replace(/\s*\(firestore\/[^\)]+\)\.?$/i,""):e,dv=n=>{const e=(n==null?void 0:n.code)||"",t=(n==null?void 0:n.message)||"";return e==="auth/wrong-password"||t.includes("wrong-password")||e==="auth/invalid-password"||t.includes("invalid-password")||e==="auth/invalid-credential"||t.includes("invalid-credential")||e==="auth/invalid-login-credentials"||t.includes("invalid-login-credentials")?"Wrong password. Please verify your credentials and try again.":e==="auth/user-not-found"||t.includes("user-not-found")?"No account found with this email. Please sign up first.":e==="auth/invalid-email"||t.includes("invalid-email")?"Please enter a valid email address.":e==="auth/email-already-in-use"||t.includes("email-already-in-use")?"An account already exists with this email address. Please sign in.":e==="auth/weak-password"||t.includes("weak-password")?"Password is too weak. Please use at least 6 characters.":e==="auth/too-many-requests"||t.includes("too-many-requests")?"Too many unsuccessful login attempts. Please try again later or reset your password.":e==="auth/network-request-failed"||t.includes("network-request-failed")?"Network error. Please check your internet connection and try again.":e==="auth/operation-not-allowed"||t.includes("operation-not-allowed")?"This authentication method is currently disabled. Please contact support.":e==="auth/requires-recent-login"||t.includes("requires-recent-login")?"This operation requires a recent login. Please log out and log in again.":t?t.replace(/^Firebase:\s*/i,"").replace(/\s*\(auth\/[^\)]+\)\.?$/i,""):"An unexpected authentication error occurred. Please try again."},Qy=n=>Cp(Ai,async e=>{Co=e,e?await bo(e.uid):Rt=null,n(e)}),Yy={"#login":()=>Ce(()=>import("./login-_oB-5TyK.js"),[]),"#dashboard":()=>Ce(()=>import("./dashboard-CSDr2bvV.js"),__vite__mapDeps([0,1,2])),"#settings":()=>Ce(()=>import("./settings-GmQ7819r.js"),__vite__mapDeps([3,1,2])),"#project":()=>Ce(()=>import("./project-detail-C--AaqMI.js"),__vite__mapDeps([4,1,2,5,6,7])),"#step1":()=>Ce(()=>import("./client-info-Drk8MKzU.js"),__vite__mapDeps([8,1,9,2])),"#step2":()=>Ce(()=>import("./architecture-DLokWkx0.js"),__vite__mapDeps([10,1,9,2,7,11])),"#step3":()=>Ce(()=>import("./air-movement-TGkDgeWJ.js"),__vite__mapDeps([12,1,9,2,7,11])),"#step4":()=>Ce(()=>import("./thermodynamics-Bs3xHHuC.js"),__vite__mapDeps([13,1,9,2,7,11])),"#step5":()=>Ce(()=>import("./filtration-CD3hjQvg.js"),__vite__mapDeps([14,1,9,2,7,11])),"#step6":()=>Ce(()=>import("./rates-D5dwyowb.js"),__vite__mapDeps([15,1,9,2,7,11])),"#step7":()=>Ce(()=>import("./quote-summary-BQhFISFD.js"),__vite__mapDeps([16,1,9,2,7,6])),"#shared":()=>Ce(()=>import("./shared-view-CWQb9CLn.js"),__vite__mapDeps([17,2,7]))},zr=document.getElementById("app");let Or=null;const Jy=()=>{zr.innerHTML=`
  ...
  `},uh=async()=>{let n=window.location.hash||"#dashboard",e=n.split("/")[0];if(e===""&&(e="#dashboard"),n.startsWith("#project")){const i=n.split("/");i.length===2?e="#project":i.length>4&&i[4]==="step"&&(e=`#step${i[5]}`)}else n.startsWith("#shared")&&(e="#shared");const t=window.currentUser;if(!t&&n!=="#login"&&!n.startsWith("#shared")){window.location.hash="#login";return}if(t&&n==="#login"){window.location.hash="#dashboard";return}const r=Yy[e];if(!r){zr.innerHTML='<div class="p-8 text-error font-headline-md">404: Page not found</div>';return}Jy();try{const i=await r();Or&&Or.unmount&&Or.unmount(),zr.innerHTML=i.render(),i.mount&&i.mount(n),Or=i}catch(i){console.error("Routing error:",i),zr.innerHTML=`<div class="p-8 text-error font-headline-md">Error loading page: ${Gy(i)}</div>`}};Qy(n=>{window.currentUser=n,uh()});window.addEventListener("hashchange",uh);export{Ce as _,ov as a,Yl as b,tv as c,ch as d,lv as e,$y as f,dv as g,iv as h,Gy as i,hv as j,zy as k,av as l,uv as m,cv as n,rv as o,nv as q,Hy as s,sv as u};
